    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?)
    {
        ...
        db.collection("encuestas")
            ...
            .addOnSuccessListener { task ->
                ...
                var adapter = EncuestaAdapterProfesor(listaEncuestas)
                ...
                adapter.setOnItemClickListener(object: EncuestaAdapterProfesor.onItemClickListener {
                ...
                searchView.setOnQueryTextListener(object: SearchView.OnQueryTextListener {
                    ...
                    override fun onQueryTextChange(newText: String?): Boolean
                    {
                        ...
                        if (searchText.isNotEmpty())
                        {
                            ...
                            var adapter = EncuestaAdapterProfesor(listaEncuestasBusqueda)
